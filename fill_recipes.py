...
def seed():
    ...
    recipes_pool = [
        ...
        ("Тофу-скрэмбл с томатами", "breakfast", "vegan", 220, 18, 12, 6, "Тофу 150г, Шпинат 30г, Томаты черри 50г, Куркума", "tofu,vegan,breakfast,healthy"),
        ("Шакшука с болгарским перцем", "breakfast", "vege", 290, 14, 18, 15, "Яйца 2шт, Томаты в с/с 100г, Перец 50г, Зира", "shakshuka,eggs,breakfast,middle-east"),
        ("Чиа-пудинг на кокосовом молоке", "breakfast", "vegan", 260, 6, 18, 22, "Семена чиа 30г, Кокосовое молоко 150мл, Манго 50г", "chia,coconut,mango,breakfast"),
        ("Омлет с лососем и шпинатом", "breakfast", "pesca", 340, 26, 22, 4, "Яйца 2шт, Слабосоленый лосось 40г, Шпинат 30г", "omlette,salmon,breakfast,protein"),
        ("Цельнозерновые вафли с ягодами", "breakfast", "vege", 310, 9, 7, 50, "Мука ц/з 60г, Яйцо 1шт, Кефир 50мл, Голубика 30г", "waffles,berries,breakfast,sweet"),
        ...
        ("Хумус с морковными палочками", "snack", "vegan", 180, 8, 10, 14, "Хумус классический 60г, Морковь 100г", "hummus,carrot,vegan,snack"),
        ("Творог с грецким орехом", "snack", "vege", 220, 18, 12, 6, "Творог 5% 120г, Грецкий орех 15г", "cottage-cheese,walnut,snack"),
        ("Кефир с семенами льна", "snack", "vege", 110, 7, 5, 8, "Кефир 1% 250мл, Семена льна 10г", "kefir,seeds,snack,healthy"),
        ("Гуакамоле с хлебцами", "snack", "vegan", 240, 4, 18, 16, "Авокадо 80г, Томаты 20г, Хлебцы рисовые 2шт", "guacamole,avocado,snack"),
        ...
        ("Паста Карбонара (легкая)", "lunch", "all", 550, 25, 30, 45, "Спагетти 80г, Бекон 30г, Сыр Пармезан 20г, Желток 1шт", "pasta,carbonara,lunch,italian"),
        ("Боул с фалафелем и кускусом", "lunch", "vegan", 480, 15, 20, 55, "Фалафель 3шт, Кускус 60г, Огурец, Соус Тахини", "falafel,bowl,vegan,lunch"),
        ("Поке с креветками и авокадо", "lunch", "pesca", 460, 28, 15, 50, "Рис для суши 80г, Креветки 100г, Чука, Соевый соус", "poke,shrimp,asian,lunch"),
        ("Индейка с бататом", "lunch", "all", 410, 35, 12, 38, "Филе индейки 150г, Батат запеченный 120г, Зелень", "turkey,sweet-potato,lunch,healthy"),
        ("Суп Минестроне", "lunch", "vegan", 190, 5, 4, 30, "Овощной бульон, Цукини, Фасоль, Сельдерей", "soup,minestrone,vegan,lunch"),
        ("Стейк из тунца с рисом", "lunch", "pesca", 430, 38, 10, 40, "Тунца филе 150г, Дикий рис 60г, Спаржевая фасоль", "tuna,rice,lunch,pesca"),
        ...
        ("Фунчоза с овощами и кунжутом", "dinner", "vegan", 290, 6, 12, 42, "Стеклянная лапша 60г, Перец, Морковь, Соевый соус", "noodles,asian,vegan,dinner"),
        ("Запеченная дорадо с травами", "dinner", "pesca", 260, 32, 8, 2, "Дорадо 1шт, Лимон, Розмарин, Оливковое масло", "fish,dorado,dinner,pesca"),
        ("Салат Цезарь с креветками", "dinner", "pesca", 310, 25, 18, 10, "Салат Романо, Креветки гриль 100г, Соус легкий", "caesar,shrimp,salad,dinner"),
        ("Говядина Стир-фрай", "dinner", "all", 380, 32, 18, 15, "Вырезка говяжья 150г, Брокколи, Перец, Кунжутное масло", "beef,stir-fry,dinner,asian"),
        ("Лапша из цукини с песто", "dinner", "vegan", 190, 5, 14, 10, "Цукини 200г, Соус Песто 30г, Кедровые орехи 10г", "zucchini,pesto,vegan,dinner"),
        ("Творожный мусс с ягодами", "dinner", "vege", 210, 25, 5, 12, "Творог мягкий 0.1% 200г, Малина 30г, Стевия", "mousse,cottage-cheese,dinner,light"),
    ]
